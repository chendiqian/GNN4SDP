...
def main(args: DictConfig):
    ...
    for run in range(args.train.runs):
        ...
        test_loss, test_obj_gap = trainer.eval(test_loader, model, local_rank)
    ...
    if rank == 0:
        wandb.log({
            ...
            'test_gap_mean': np.mean(test_losses),
            'test_gap_std': np.std(test_losses),
